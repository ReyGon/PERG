...
Public Class frmGruposUsuarios
    Private Sub frmGruposUsuarios_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        llenagrid()
    End Sub
    ...
    Private Sub llenagrid()
        Try
            ...
            Dim Data = From x In ctx.tblGrupoUsuarios _
                       Select Codigo = x.idGrupo, Nombre = x.nombre
    ...
    Private Sub frm_grabaRegistro() Handles Me.grabaRegistro
        ...
        Dim m As New tblGrupoUsuario
        Try
            m.nombre = txtNombre.Text

            ctx.AddTotblGrupoUsuarios(m)
            ctx.SaveChanges()
    ...
    Private Sub frm_modificaRegistro() Handles Me.modificaRegistro
        Try
            Dim m As tblGrupoUsuario = (From e1 In ctx.tblGrupoUsuarios Where e1.idGrupo = Me.txtCodigo.Text Select e1).First()
            m.nombre = txtNombre.Text
            ctx.SaveChanges()
    ...
    Private Sub fnDocSalida() Handles Me.reporte
        frmDocumentosSalida.txtTitulo.Text = "Lista: Grupos de Usuario"
