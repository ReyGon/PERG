...
Public Class frmCierreCajaNuevo
...
#Region "Funciones"
    ...
    Private Sub fnLlenarGrid()
        ...
        Dim listado = (From x In ctx.tblCajas
                       Where x.fechaCobro >= desde And x.fechaCobro <= hasta And x.usuario = mdlPublicVars.idUsuario And x.confirmado _
                       And x.cierreCaja Is Nothing And x.cuenta Is Nothing
    ...
    Private Sub fnGuardarCierre()
        ...
        Using transaction As New TransactionScope
            Try
                ...
                cierre.total = cierre.entrada - cierre.salida
