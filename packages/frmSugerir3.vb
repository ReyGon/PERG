...
Public Class frmSugerir3
        ...
        Try
            ...
            If buscar Then
                If bitMovimientoInventario = True Then
                    cons = ctx.sp_cuantocomprar(mdlPublicVars.idEmpresa, txtFiltro.Text, idInventario, idBodega, codigoTipoVehiculo, codigomodeloVehiculo, codClie, 1, True, False, codigoMarcaRepuesto, venta)
                    pgLiquidacion.Dispose()
                    pgbProgreso.Value = 30
                Else
                    cons = ctx.sp_cuantocomprar(mdlPublicVars.idEmpresa, txtFiltro.Text, idInventario, idBodega, codigoTipoVehiculo, codigomodeloVehiculo, codClie, 1, bitCliente, bitProveedor, codigoMarcaRepuesto, venta)
                    pgbProgreso.Value = 15
                    If Not bitProveedor Then
                        cons2 = ctx.sp_cuantocomprar(mdlPublicVars.idEmpresa, txtFiltro.Text, mdlPublicVars.General_InventarioLiquidacion, mdlPublicVars.General_idAlmacenPrincipal, codigoTipoVehiculo, codigomodeloVehiculo, codClie, 1, bitCliente, bitProveedor, codigoMarcaRepuesto, venta)
                        pgbProgreso.Value = 15
                    End If
                End If
            Else
    ...
    Private Sub fnLlenar_gridsinfiltro()
        Try
            ...
            If buscar Then
                If bitMovimientoInventario = True Then
                    cons = ctx.sp_cargarProductosCompra(mdlPublicVars.idEmpresa, idInventario, idBodega, codigoTipoVehiculo, codigomodeloVehiculo, codClie, 1, True, False, codigoMarcaRepuesto, venta)
                    pgLiquidacion.Dispose()
                    pgbProgreso.Value = 30
                Else
                    cons = ctx.sp_cargarProductosCompra(mdlPublicVars.idEmpresa, idInventario, idBodega, codigoTipoVehiculo, codigomodeloVehiculo, codClie, 1, bitCliente, bitProveedor, codigoMarcaRepuesto, venta)
                    pgbProgreso.Value = 15
                    If Not bitProveedor Then
                        cons2 = ctx.sp_cargarProductosCompra(mdlPublicVars.idEmpresa, mdlPublicVars.General_InventarioLiquidacion, mdlPublicVars.General_idAlmacenPrincipal, codigoTipoVehiculo, codigomodeloVehiculo, codClie, 1, bitCliente, bitProveedor, codigoMarcaRepuesto, venta)
                        pgbProgreso.Value = 15
                    End If
                End If
            Else
