...
Public Class rptNotaCrédito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptNotaCrédito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNotaCrédito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNotaCrédito = New rptNotaCrédito()
        rpt.Site = Me.Site
        Return rpt
    End Function
