...
Public Class factura_Factura22
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.factura_Factura22.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfactura_Factura22
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As factura_Factura22 = New factura_Factura22()
        rpt.Site = Me.Site
        Return rpt
    End Function
