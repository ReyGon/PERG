...
Public Class rptPickingPedido
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptPickingPedido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPickingPedido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPickingPedido = New rptPickingPedido()
        rpt.Site = Me.Site
        Return rpt
    End Function
