...
Public Class ventas_Picking
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.ventas_Picking.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedventas_Picking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ventas_Picking = New ventas_Picking()
        rpt.Site = Me.Site
        Return rpt
    End Function
