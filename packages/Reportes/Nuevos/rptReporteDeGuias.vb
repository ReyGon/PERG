...
Public Class rptReporteDeGuias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptReporteDeGuias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteDeGuias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteDeGuias = New rptReporteDeGuias()
        rpt.Site = Me.Site
        Return rpt
    End Function
