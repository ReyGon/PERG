...
Public Class ventas_Cotizacion2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.ventas_Cotizacion2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedventas_Cotizacion2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ventas_Cotizacion2 = New ventas_Cotizacion2()
        rpt.Site = Me.Site
        Return rpt
    End Function
