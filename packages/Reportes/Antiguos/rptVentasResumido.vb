...
Public Class rptVentasResumido
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptVentasResumido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasResumido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasResumido = New rptVentasResumido()
        rpt.Site = Me.Site
        Return rpt
    End Function
