...
Public Class rptArticuloCostos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptArticuloCostos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptArticuloCostos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptArticuloCostos = New rptArticuloCostos()
        rpt.Site = Me.Site
        Return rpt
    End Function
