...
Public Class rptVentasDetalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptVentasDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasDetalle = New rptVentasDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
