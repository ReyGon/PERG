...
Public Class rptComprasResumen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptComprasResumen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptComprasResumen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptComprasResumen = New rptComprasResumen()
        rpt.Site = Me.Site
        Return rpt
    End Function
