...
Public Class rptVentasUtilidad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptVentasUtilidad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasUtilidad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasUtilidad = New rptVentasUtilidad()
        rpt.Site = Me.Site
        Return rpt
    End Function
