...
Public Class rptReciboCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptReciboCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReciboCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReciboCaja = New rptReciboCaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
