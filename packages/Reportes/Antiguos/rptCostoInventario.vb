...
Public Class rptCostoInventario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptCostoInventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCostoInventario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCostoInventario = New rptCostoInventario()
        rpt.Site = Me.Site
        Return rpt
    End Function
