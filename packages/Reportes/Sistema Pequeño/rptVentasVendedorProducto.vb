...
Public Class rptVentasVendedorProducto
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptVentasVendedorProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptVentasVendedorProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_top() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptVentasVendedorProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasVendedorProducto = New rptVentasVendedorProducto()
        rpt.Site = Me.Site
        Return rpt
    End Function
