...
Public Class rptMasVendidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptMasVendidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMasVendidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMasVendidos = New rptMasVendidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
