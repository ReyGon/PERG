...
Public Class rptPromedioCompra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptPromedioCompra.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idartiulo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptPromedioCompra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPromedioCompra = New rptPromedioCompra()
        rpt.Site = Me.Site
        Return rpt
    End Function
