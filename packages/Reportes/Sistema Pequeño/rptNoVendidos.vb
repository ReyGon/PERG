...
Public Class rptNoVendidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptNoVendidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNoVendidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNoVendidos = New rptNoVendidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
