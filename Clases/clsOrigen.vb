'------------------------------------------------------------------------------
' Clase clsOrigen generada automáticamente con CrearClaseSQL
...
Public Class clsOrigen
    ...
    Public Function Actualizar() As String
        ...
        '       yo uso el idOrigen que es el identificador único de cada registro
    ...
    Public Function Actualizar(ByVal sel As String) As String
        ...
        '       Ese campo, (en mi caso idOrigen) será el que hay que poner al final junto al WHERE.
