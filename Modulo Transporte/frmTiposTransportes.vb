...
Public Class frmTiposTransportes
    ...
    Private Sub llenagrid()
        ...
        Using conn As EntityConnection = New EntityConnection(mdlPublicVars.entityBuilder.ToString)
            ...
            'CONSULTAR REGISTROS
            Dim data = From x In ctx.tblTiposTransportes Select Codigo = x.idTipoTransporte, Nombre = x.descripcion
    ...
    Private Sub frm_grabaRegistro() Handles Me.grabaRegistro
        ...
        Using conn As EntityConnection = New EntityConnection(mdlPublicVars.entityBuilder.ToString)
            ...
            Dim m As New tblTiposTransporte
            Try
                m.descripcion = txtNombre.Text
                ctx.AddTotblTiposTransportes(m)
                ctx.SaveChanges()
                alertas.fnGuardar()
                Call llenagrid()
    ...
    Private Sub frm_modificaRegistro() Handles Me.modificaRegistro
        ...
        Using conn As EntityConnection = New EntityConnection(mdlPublicVars.entityBuilder.ToString)
            ...
            Try
                Dim m As tblTiposTransporte = (From e1 In ctx.tblTiposTransportes Where e1.idTipoTransporte = Me.txtCodigo.Text Select e1).First()
                m.descripcion = txtNombre.Text
