...
Public Class frmModeloVehiculo

    Private Sub frmModeloVehiculo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub llenagrid()
        Try
            ...
            Dim Data = From x In ctx.tblArticuloModeloVehiculoes Select Codigo = x.codigo, x.nombre, x.abreviatura
    ...
    Private Sub frm_grabaRegistro() Handles Me.grabaRegistro
        ...
        Dim m As New tblArticuloModeloVehiculo
        Try
            m.nombre = txtNombre.Text
            m.abreviatura = txtAbreviatura.Text
            ctx.AddTotblArticuloModeloVehiculoes(m)
            ctx.SaveChanges()
    ...
    Private Sub frm_modificaRegistro() Handles Me.modificaRegistro
        Try
            ...
            Dim m As tblArticuloModeloVehiculo = (From e1 In ctx.tblArticuloModeloVehiculoes Where e1.codigo = Me.txtCodigo.Text Select e1).First()
            m.nombre = txtNombre.Text
            m.abreviatura = txtAbreviatura.Text
            ctx.SaveChanges()
    ...
    Private Sub fnDocSalida() Handles Me.reporte
        frmDocumentosSalida.txtTitulo.Text = "Lista: Modelo de Vehiculos"
