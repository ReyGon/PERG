...
Public Class frmMarcaRepuestos
    Private Sub frmMarcaRepuestos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub llenagrid()
        Try
            ...
            Dim Data = From x In ctx.tblArticuloMarcaRepuestoes Select Codigo = x.codigo, x.nombre
    ...
    Private Sub frm_grabaRegistro() Handles Me.grabaRegistro
        ...
        Dim m As New tblArticuloMarcaRepuesto
        Try
            m.nombre = txtNombre.Text

            ctx.AddTotblArticuloMarcaRepuestoes(m)
            ctx.SaveChanges()
    ...
    Private Sub frm_modificaRegistro() Handles Me.modificaRegistro
        Try
            ...
            Dim m As tblArticuloMarcaRepuesto = (From e1 In ctx.tblArticuloMarcaRepuestoes Where e1.codigo = Me.txtCodigo.Text Select e1).First()
            m.nombre = txtNombre.Text
    ...
    Private Sub fnDocSalida() Handles Me.reporte
        frmDocumentosSalida.txtTitulo.Text = "Lista: Marca de Repuestos"
