...
Public Class frmImportancia

    Private Sub frmImportancia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub llenagrid()
        Try
            ...
            Dim Data = From x In ctx.tblArticuloImportancias Select Codigo = x.codigo, x.nombre
    ...
    Private Sub frm_grabaRegistro() Handles Me.grabaRegistro
        ...
        Dim m As New tblArticuloImportancia
        Try
            m.nombre = txtNombre.Text

            ctx.AddTotblArticuloImportancias(m)
            ctx.SaveChanges()
    ...
    Private Sub frm_modificaRegistro() Handles Me.modificaRegistro
        Try
            ...
            Dim m As tblArticuloImportancia = (From e1 In ctx.tblArticuloImportancias Where e1.codigo = Me.txtCodigo.Text Select e1).First()
            m.nombre = txtNombre.Text
    ...
    Private Sub fnDocSalida() Handles Me.reporte
        frmDocumentosSalida.txtTitulo.Text = "Lista: Tipos de Importancia de Artículos"
