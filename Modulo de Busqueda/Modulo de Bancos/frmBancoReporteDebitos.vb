...
Public Class frmBancoReporteDebitos

    Private Sub frmBancoReporteDebitos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub fnLlenarGrid()
        ...
        Dim datos As DataTable = EntitiToDataTable(ctx.sp_reporteDebitos("", desde, hasta, idBeneficiario, idConcepto, idBanco, idCuenta,
    ...
    Public Sub fnReporte() Handles Me.panel0
        ...
        Try
            r.reporte = "rptDebitos.rpt"
            r.tabla = grdDatos.DataSource
            r.nombreParametro = "filtro"
            r.parametro = "Filtro del reporte:  "

            frmDocumentosSalida.txtTitulo.Text = "Listado de Conceptos de Débitos, Desde " & dtpFechaInicio.Text & " Hasta " & dtpFechaFin.Text
