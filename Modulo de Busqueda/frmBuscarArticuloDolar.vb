...
Public Class frmBuscarArticuloDolar
    ...
    Private Sub fnLlenar_productos()
        Try
            ...
            If buscar Then
                ...
                Else
                    cons = ctx.sp_buscar_ArticuloDolar(mdlPublicVars.idEmpresa, txtFiltro.Text, idInventario, idBodega, codigoTipoVehiculo, codigomodeloVehiculo, codClie, 1, bitCliente, bitProveedor, codigoMarcaRepuesto, venta)
