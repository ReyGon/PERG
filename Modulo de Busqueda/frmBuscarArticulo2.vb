...
Public Class frmBuscarArticulo2
    ...
    Private _bitProduccionEntrada As Boolean
    Private _bitProduccionSalida As Boolean
    ...
    Public Property bitProduccionEntrada() As Boolean
        Get
            bitProduccionEntrada = _bitProduccionEntrada
        End Get
        Set(value As Boolean)
            _bitProduccionEntrada = value
        End Set
    End Property

    Public Property bitProduccionSalida() As Boolean
        Get
            bitProduccionSalida = _bitProduccionSalida
        End Get
        Set(value As Boolean)
            _bitProduccionSalida = value
        End Set
    End Property
        ...
        Try
            ...
            If buscar Then
                If bitMovimientoInventario = True Then
                    If bitProduccion = True Then

                        cons = ctx.sp_buscar_ArticuloUNIDAD(mdlPublicVars.idEmpresa, txtFiltro.Text, idTipoInventario, idBodega, codigoTipoVehiculo, codigomodeloVehiculo, codClie, 1, True, False, codigoMarcaRepuesto, venta)
                        pgLiquidacion.Dispose()
                        ''Dim ttemp As New DataTable
                        ''ttemp = mdlPublicVars.EntitiToDataTable(cons)
                        ''ttemp = From x In ctx.sp_buscar_ArticuloUNIDAD(mdlPublicVars.idEmpresa, txtFiltro.Text, idTipoInventario, mdlPublicVars.General_idAlmacenPrincipal, codigoTipoVehiculo, codigomodeloVehiculo, codClie, 1, True, False, codigoMarcaRepuesto, venta).ToList()
                        pgbProgreso.Value = 30

                    Else

                        cons = ctx.sp_buscar_Articulo(mdlPublicVars.idEmpresa, txtFiltro.Text, mdlPublicVars.General_idTipoInventario, mdlPublicVars.General_idAlmacenPrincipal, codigoTipoVehiculo, codigomodeloVehiculo, codClie, 1, True, False, codigoMarcaRepuesto, venta)
                        pgLiquidacion.Dispose()
                        pgbProgreso.Value = 30

                    End If
                Else
                    cons = ctx.sp_buscar_Articulo(mdlPublicVars.idEmpresa, txtFiltro.Text, mdlPublicVars.General_idTipoInventario, mdlPublicVars.General_idAlmacenPrincipal, codigoTipoVehiculo, codigomodeloVehiculo, codClie, 1, bitCliente, bitProveedor, codigoMarcaRepuesto, venta)
    ...
    Private Sub fnConfiguracion(ByRef grd As Telerik.WinControls.UI.RadGridView)
        Try
            If grd.ColumnCount > 2 Then
                ...
                grd.Columns(9).IsVisible = False 'reserva
                grd.Columns(13).IsVisible = False 'cantidad Maxima
                grd.Columns(14).IsVisible = False 'observacion
                grd.Columns(15).IsVisible = False 'empaque
                grd.Columns(16).IsVisible = False 'surtir
                grd.Columns(17).IsVisible = False 'clrEstado
                grd.Columns(18).IsVisible = False 'numero de articulo en catalogo
                grd.Columns(19).IsVisible = False 'fecha ultima compra
                grd.Columns(20).IsVisible = False 'marca
                grd.Columns(21).IsVisible = False 'bitVentaMaxima
                grd.Columns(22).IsVisible = False 'minimo
                ...
                grd.Columns(4).Width = 75 ' cantidad
                grd.Columns(5).Width = 75 ' existencia
                ...
                grd.Columns(14).Width = 60
                grd.Columns(15).Width = 70
                grd.Columns(23).Width = 75 ' UNIDAD MEDIDA  
    ...
    Private Sub fnAgregar_Productos(ByRef grd As Telerik.WinControls.UI.RadGridView, ByVal liquidacion As Boolean)
                    ...
                    If cantidad > 0 Or surtir > 0 Then
                        ...
                        If cont = 1 Then
                            ...
                            ElseIf bitMovimientoInventario = True Then
                                If bitProduccion = True Then
                                    If bitProduccionEntrada = True Then
                                        frmProduccion.fnRemoverFilaEntrada()
                                    ElseIf bitProduccionSalida = True Then
                                        frmProduccion.fnRemoverFilaSalida()
                                    ElseIf bitMovimientoInventario = True And bitProduccion = True And bitProduccionEntrada = False And bitProduccionSalida = False Then
                        ...
                        ElseIf bitMovimientoInventario = True Then
                            mdlPublicVars.superSearchPrecio = costo
                            If bitProduccion = True Then
                                If bitProduccionEntrada Then
                                    frmProduccion.fnAgregar_ArticulosEntrada()
                                ElseIf bitProduccionSalida = True Then
                                    frmProduccion.fnAgregar_ArticulosSalida()
                                ElseIf bitProduccion = True And bitMovimientoInventario = True And bitProduccionEntrada = False And bitProduccionSalida = False Then
        ...
        If cont > 0 Then
            ...
            ElseIf bitMovimientoInventario = True Then
                If bitProduccion = True Then
                    If bitProduccionEntrada = True Then
                        frmProduccion.fnNuevaFilaEntrada()
                    ElseIf bitProduccionSalida = True Then
                        frmProduccion.fnNuevaFilaSalida()
                    Else
