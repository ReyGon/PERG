        ...
        Try
            ...
            If tipo = "entrada" Then
                lista = (From x In ctx.tblEntradasDetalles
                         Where x.tblEntrada.anulado = False And x.idArticulo = codigo And x.tblEntrada.idProveedor = codClie And x.cantidad > 0 _
                ...
                general = (From x In ctx.tblEntradasDetalles Where x.tblEntrada.anulado = False And x.idArticulo = codigo And x.cantidad > 0 _
                ...
                rpvDatos.Pages(0).Text = "Proveedor"
            ElseIf tipo = "salidas" Then
                lista = (From x In ctx.tblSalidaDetalles Where x.tblSalida.anulado = False _
                         And x.tblSalida.empacado = True And x.idArticulo = codigo And x.tblSalida.idCliente = codClie And x.cantidad > 0 _
                ...
                general = (From x In ctx.tblSalidaDetalles Where x.tblSalida.anulado = False And x.tblSalida.empacado = True And x.idArticulo = codigo And x.cantidad > 0 _
                ...
                rpvDatos.Pages(0).Text = "Cliente"


            ElseIf tipo = "movimientoInventario" Then
