...
Public Class frmFletes
    ...
    Private Sub llenagrid()
        Try
            ...
            Dim Data = From x In ctx.tblProveedorTipoFletes Select Codigo = x.codigo, x.nombre
    ...
    Private Sub frm_grabaRegistro() Handles Me.grabaRegistro
        ...
        Dim m As New tblProveedorTipoFlete
        Try
            m.nombre = txtNombre.Text

            ctx.AddTotblProveedorTipoFletes(m)
            ctx.SaveChanges()
    ...
    Private Sub frm_modificaRegistro() Handles Me.modificaRegistro
        Try
            ...
            Dim m As tblProveedorTipoFlete = (From e1 In ctx.tblProveedorTipoFletes Where e1.codigo = Me.txtCodigo.Text Select e1).First()
            m.nombre = txtNombre.Text
    ...
    Private Sub fnDocSalida() Handles Me.reporte
        frmDocumentosSalida.txtTitulo.Text = "Lista: Tipo de Fletes"
