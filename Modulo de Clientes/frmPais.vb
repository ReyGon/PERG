...
Public Class frmPais
    ...
    Private Sub llenagrid()
        Try
            ...
            Dim Data = From x In ctx.tblpais Select Codigo = x.idpais, x.nombre
    ...
    Private Sub frm_modificaRegistro() Handles Me.modificaRegistro
        Try
            ...
            Dim m As tblpai = (From e1 In ctx.tblpais Where e1.idpais = Me.txtCodigo.Text Select e1).First()
            m.nombre = txtNombre.Text
    ...
    Private Sub fnDocSalida() Handles Me.reporte
        frmDocumentosSalida.txtTitulo.Text = "Lista: Paises"
