...
Public Class frmCategoriaBitacoraCliente
    ...
    Private Sub llenagrid()
        ...
        Try
            ...
            Dim Data = From x In ctx.tblBitacoraCategorias Where x.cliente = True Select Codigo = x.IdBitacoraCategoria, x.Nombre
    ...
    Private Sub fnDocSalida() Handles Me.reporte
        frmDocumentosSalida.txtTitulo.Text = "Lista: Categorias de Bitacoras de Clientes"
