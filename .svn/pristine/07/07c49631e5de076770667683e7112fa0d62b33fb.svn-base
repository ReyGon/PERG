...
Public Class frmTipoInventario

    Private Sub frmTipoInventario_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub llenagrid()
        Try
            ...
            Dim Data = From x In ctx.tblTipoInventarios Select Codigo = x.idTipoinventario, x.nombre
    ...
    Private Sub frm_grabaRegistro() Handles Me.grabaRegistro
        ...
        Dim m As New tblTipoInventario
        Try
            m.nombre = txtNombre.Text
            m.empresa = mdlPublicVars.idEmpresa
            ctx.AddTotblTipoInventarios(m)
            ctx.SaveChanges()
    ...
    Private Sub frm_modificaRegistro() Handles Me.modificaRegistro
        Try
            ...
            Dim m As tblTipoInventario = (From e1 In ctx.tblTipoInventarios Where e1.idTipoinventario = Me.txtCodigo.Text Select e1).First()
            m.nombre = txtNombre.Text
            m.empresa = mdlPublicVars.idEmpresa
            ctx.SaveChanges()
    ...
    Private Sub fnDocSalida() Handles Me.reporte
        frmDocumentosSalida.txtTitulo.Text = "Lista: Tipos de Inventario"
