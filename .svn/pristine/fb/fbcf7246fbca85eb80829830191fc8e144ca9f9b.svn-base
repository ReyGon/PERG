...
Public Class frmProveedorDevolucionGuia
    ...
    Private Sub fnLlenarDatos()
        ...
        Dim devolucion As tblDevolucionProveedor = (From x In ctx.tblDevolucionProveedors.AsEnumerable Where x.codigo = codigo _
                                                  Select x).FirstOrDefault

        'Asignamos los datos
        lblDocumento.Text = devolucion.documento
        lblFecha.Text = Format(devolucion.fechaRegistro, mdlPublicVars.formatoFecha)
        lblProveedor.Text = devolucion.tblProveedor.negocio
    End Sub
    ...
    Private Sub llenagrid()
        ...
        Dim companyInfo = From x In ctx.tblEnvio_DevolucionProveedor Where x.devolucionProveedor = codigo
    ...
    Private Sub frm_eliminaRegistro() Handles Me.eliminaRegistro
        ...
        Try
            Dim m As tblEnvio_DevolucionProveedor = (From e1 In ctx.tblEnvio_DevolucionProveedor Where e1.envio = Me.txtCodigo.Text Select e1).First()
            ctx.DeleteObject(m)
    ...
    Private Sub btnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        ...
        Try
            ...
            Dim guia_factura As New tblEnvio_DevolucionProveedor
            guia_factura.envio = m.codigo
            guia_factura.devolucionProveedor = codigo

            ctx.AddTotblEnvio_DevolucionProveedor(guia_factura)
