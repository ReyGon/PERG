...
Public Class frmTipoVehiculo
    Private Sub frmTipoVehiculo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub llenagrid()
        Try
            ...
            Dim Data = From x In ctx.tblArticuloTipoVehiculoes _
                       Select Codigo = x.codigo, x.nombre, x.orden
    ...
    Private Sub frm_grabaRegistro() Handles Me.grabaRegistro
        ...
        Dim m As New tblArticuloTipoVehiculo
        Try
            m.nombre = txtNombre.Text
            m.orden = nm0Orden.Value
            ctx.AddTotblArticuloTipoVehiculoes(m)
            ctx.SaveChanges()
    ...
    Private Sub frm_modificaRegistro() Handles Me.modificaRegistro
        Try
            ...
            Dim m As tblArticuloTipoVehiculo = (From e1 In ctx.tblArticuloTipoVehiculoes Where e1.codigo = Me.txtCodigo.Text Select e1).First()
            m.nombre = txtNombre.Text
            m.orden = nm0Orden.Value
            ctx.SaveChanges()
    ...
    Private Sub fnDocSalida() Handles Me.reporte
        frmDocumentosSalida.txtTitulo.Text = "Lista: Tipo de Vehiculos"
