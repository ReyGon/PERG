...
Public Class frmClasificacionCompra

    Private Sub frmClasificacionCompra_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub llenagrid()
        Try
            ...
            Dim Data = From x In ctx.tblClienteClasificacionCompras Select Codigo = x.idClasificacionCompra, x.nombre
    ...
    Private Sub frm_grabaRegistro() Handles Me.grabaRegistro
        ...
        Dim m As New tblClienteClasificacionCompra
        Try
            m.nombre = txtNombre.Text

            ctx.AddTotblClienteClasificacionCompras(m)
            ctx.SaveChanges()
    ...
    Private Sub frm_modificaRegistro() Handles Me.modificaRegistro
        Try
            ...
            Dim m As tblClienteClasificacionCompra = (From e1 In ctx.tblClienteClasificacionCompras Where e1.idClasificacionCompra = Me.txtCodigo.Text Select e1).First()
            m.nombre = txtNombre.Text
    ...
    Private Sub fnDocSalida() Handles Me.reporte
        frmDocumentosSalida.txtTitulo.Text = "Lista: Clasificación de Compra de Cliente"
