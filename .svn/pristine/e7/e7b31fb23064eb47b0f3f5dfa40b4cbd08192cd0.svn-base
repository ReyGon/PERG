...
Public Class frmBancoReporteCreditos

    Private Sub frmBancoReporteCreditos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub fnLlenaCombo()
        ...
        'BENEFICIARIO
        Dim beneficiario = (From x In ctx.tblBanco_Beneficiario Where x.bitCredito Take 1 Select New With {.codigo = 0, .nombre = "Todos"}).Union(
    ...
    Private Sub fnLlenarGrid()
        ...
        Dim datos As DataTable = EntitiToDataTable(ctx.sp_reporteCreditos("", desde, hasta, idBeneficiario, idConcepto, idBanco, idCuenta,
    ...
    Private Sub fnConfiguracion()
        If Me.grdDatos.ColumnCount > 0 Then
            ...
            Me.grdDatos.Columns("Acreditador").Width = 125
    ...
    Public Sub fnReporte() Handles Me.panel0
        ...
        Try
            r.reporte = "rptCreditos.rpt"
            r.tabla = grdDatos.DataSource
            r.nombreParametro = "filtro"
            r.parametro = "Filtro del reporte:  "

            frmDocumentosSalida.txtTitulo.Text = "Listado de Conceptos de Créditos, Desde " & dtpFechaInicio.Text & " Hasta " & dtpFechaFin.Text
