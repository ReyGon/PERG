...
Public Class frmBaseTelerik
    ...
    Private Sub fnSalir()
        If RadMessageBox.Show("Desea Salir de " + Me.Text.ToString, "Salir...", MessageBoxButtons.YesNo, RadMessageIcon.Question) = Windows.Forms.DialogResult.Yes Then
            Me.Close()
        End If
    End Sub
    ...
    Private Function fnMetodosAbreviados(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        If e.KeyValue = Keys.F2 And ActivarBarraLateral = True Then
            ...
            Try
                frmBarraLateralBaseIzquierda.Show()
            Catch ex As Exception
    ...
    Private Sub fnPanel5()
        If RadMessageBox.Show("Desea salir !!!", "", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
            Me.Close()
        End If
    End Sub
