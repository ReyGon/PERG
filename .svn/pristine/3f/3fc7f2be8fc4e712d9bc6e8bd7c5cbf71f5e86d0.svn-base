...
Public Class frmTipoRepuestos
    Private Sub frmTipoRepuestos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub llenagrid()
        Try
            ...
            Dim Data = From x In ctx.tblArticuloRepuestoes Select Codigo = x.codigo, x.nombre
    ...
    Private Sub frm_grabaRegistro() Handles Me.grabaRegistro
        ...
        Dim m As New tblArticuloRepuesto
        Try
            m.nombre = txtNombre.Text

            ctx.AddTotblArticuloRepuestoes(m)
            ctx.SaveChanges()
    ...
    Private Sub frm_modificaRegistro() Handles Me.modificaRegistro
        Try
            ...
            Dim m As tblArticuloRepuesto = (From e1 In ctx.tblArticuloRepuestoes Where e1.codigo = Me.txtCodigo.Text Select e1).First()
            m.nombre = txtNombre.Text
    ...
    Private Sub fnDocSalida() Handles Me.reporte
        frmDocumentosSalida.txtTitulo.Text = "Lista: Tipo de Repuestos"
