...
Public Class FrmBarraLateral
    ...
    Public Function fnAjustarTamano()
        Dim baseX As Integer = mdlPublicVars.frmX
        Dim baseY As Integer = mdlPublicVars.frmY
        Dim basePosX As Integer = mdlPublicVars.frmPosX
        Dim basePosY As Integer = mdlPublicVars.frmPosY
        ...
        If izquierda = True Then
            ...
            Me.Size = New Size(Me.Size.Width, baseY)
        End If

        If derecha = True Then
            Me.Location = New Point(baseX - Me.Size.Width - 10, 0)
            'cambiar el tamaño del panel que contiene el grid o lista.
            Me.Size = New Size(Me.Size.Width, baseY)
        End If
    ...
    Private Sub FrmBarraLateral_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            actual = 0
            ...
            Try
                ...
                Next
                paneles(1).BackColor = Color.LightBlue
                actual = 1
    ...
    Private Sub FnPanel_agregarEventos(ByVal pnl As Panel)
        ...
        Dim numeroChar = mdlPublicVars.tipoControlRango(nombre, 3, 1)
        ...
        For Each ctl In pnl.Controls
            ...
            If nombre <> "" Then
                ...
                iniciales = mdlPublicVars.tipoControl(nombre)
                rango = mdlPublicVars.tipoControlRango(nombre, 3, 1)
                If IsNumeric(rango) Or rango.Equals("A") Or rango.Equals("B") Then
                    numeroChar = mdlPublicVars.tipoControlRango(nombre, 3, 1)

                    If numeroChar.Equals("A") Then
                        numero = 10
                    ElseIf numeroChar.Equals("B") Then
                        numero = 11
                    End If
    ...
    Private Sub paneles_leave_mouseLeave(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        DirectCast(sender, Panel).BackColor = Color.LightBlue
    ...
    Private Sub paneles_abajo_arriba(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PreviewKeyDownEventArgs)
        ...
        If e.KeyValue = Keys.Down Or e.KeyValue = Keys.Up Or e.KeyValue = Keys.Left Or e.KeyValue = Keys.Right Then
            ...
            If (actual + 1 < contador) And (e.KeyValue = Keys.Down Or e.KeyValue = Keys.Right) Then
                actual = actual + 1
            End If

            If (actual - 1 >= 0) And (e.KeyValue = Keys.Up Or e.KeyValue = Keys.Left) Then
                actual = actual - 1
            End If

            'pintar el panel Actual.
            paneles(actual).Focus()
            paneles(actual).BackColor = Color.LightBlue
