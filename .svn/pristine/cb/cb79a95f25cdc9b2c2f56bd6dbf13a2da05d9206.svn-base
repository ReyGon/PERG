...
Public Class frmAlmacen
    ...
    Private Sub llenagrid()
        Try
            ...
            Dim Data = From x In ctx.tblAlmacens Select Codigo = x.codigo, x.nombre
    ...
    Private Sub frm_grabaRegistro() Handles Me.grabaRegistro
        ...
        Dim m As New tblAlmacen
        Try
            m.nombre = txtNombre.Text
            m.empresa = mdlPublicVars.idEmpresa

            ctx.AddTotblAlmacens(m)
            ctx.SaveChanges()
    ...
    Private Sub frm_modificaRegistro() Handles Me.modificaRegistro
        Try
            ...
            Dim m As tblAlmacen = (From e1 In ctx.tblAlmacens Where e1.codigo = Me.txtCodigo.Text Select e1).First()
            m.nombre = txtNombre.Text
    ...
    Private Sub fnDocSalida() Handles Me.reporte
        frmDocumentosSalida.txtTitulo.Text = "Lista: Almacenes"
