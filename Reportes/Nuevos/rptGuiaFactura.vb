...
Public Class rptGuiaFactura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptGuiaFactura.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_envio_Factura() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptGuiaFactura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGuiaFactura = New rptGuiaFactura()
        rpt.Site = Me.Site
        Return rpt
    End Function
