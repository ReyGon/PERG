...
Public Class factura_FacturaConDescCR
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "factura_FacturaConDescCR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.factura_FacturaConDescCR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfactura_FacturaConDescCR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As factura_FacturaConDescCR = New factura_FacturaConDescCR()
        rpt.Site = Me.Site
        Return rpt
    End Function
