...
Public Class factura_Factura1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.factura_Factura1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfactura_Factura1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As factura_Factura1 = New factura_Factura1()
        rpt.Site = Me.Site
        Return rpt
    End Function
