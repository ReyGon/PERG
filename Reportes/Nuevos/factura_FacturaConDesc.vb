...
Public Class factura_FacturaConDesc
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "factura_FacturaConDesc.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.factura_FacturaConDesc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfactura_FacturaConDesc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As factura_FacturaConDesc = New factura_FacturaConDesc()
        rpt.Site = Me.Site
        Return rpt
    End Function
