...
Public Class rptAplicacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptAplicacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAplicacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAplicacion = New rptAplicacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
