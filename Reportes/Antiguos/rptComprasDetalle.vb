...
Public Class rptComprasDetalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptComprasDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptComprasDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptComprasDetalle = New rptComprasDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
