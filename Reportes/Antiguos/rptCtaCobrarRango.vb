...
Public Class rptCtaCobrarRango
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptCtaCobrarRango.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCtaCobrarRango
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCtaCobrarRango = New rptCtaCobrarRango()
        rpt.Site = Me.Site
        Return rpt
    End Function
