...
Public Class rptResumenVendedor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptResumenVendedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenVendedor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenVendedor = New rptResumenVendedor()
        rpt.Site = Me.Site
        Return rpt
    End Function
