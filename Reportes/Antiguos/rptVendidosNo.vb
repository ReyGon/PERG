...
Public Class rptVendidosNo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptVendidosNo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVendidosNo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVendidosNo = New rptVendidosNo()
        rpt.Site = Me.Site
        Return rpt
    End Function
