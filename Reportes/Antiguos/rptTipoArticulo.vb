...
Public Class rptTipoArticulo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptTipoArticulo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTipoArticulo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTipoArticulo = New rptTipoArticulo()
        rpt.Site = Me.Site
        Return rpt
    End Function
