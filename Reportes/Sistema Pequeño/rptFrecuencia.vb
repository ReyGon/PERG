...
Public Class rptFrecuencia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptFrecuencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFrecuencia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFrecuencia = New rptFrecuencia()
        rpt.Site = Me.Site
        Return rpt
    End Function
