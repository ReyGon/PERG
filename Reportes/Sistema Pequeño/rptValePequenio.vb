...
Public Class rptValePequenio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptValePequenio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptValePequenio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptValePequenio = New rptValePequenio()
        rpt.Site = Me.Site
        Return rpt
    End Function
