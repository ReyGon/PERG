...
Public Class rptTransporteMedio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptTransporteMedio.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idSalidaTransporteMedio() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptTransporteMedio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTransporteMedio = New rptTransporteMedio()
        rpt.Site = Me.Site
        Return rpt
    End Function
