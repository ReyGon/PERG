...
Public Class rptFacturaPequenio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptFacturaPequenio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturaPequenio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaPequenio = New rptFacturaPequenio()
        rpt.Site = Me.Site
        Return rpt
    End Function
