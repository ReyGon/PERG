...
Public Class rptParticipacionMercado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptParticipacionMercado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptParticipacionMercado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptParticipacionMercado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptParticipacionMercado = New rptParticipacionMercado()
        rpt.Site = Me.Site
        Return rpt
    End Function
