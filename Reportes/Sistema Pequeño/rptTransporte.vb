...
Public Class rptTransporte
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptTransporte.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTransporte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTransporte = New rptTransporte()
        rpt.Site = Me.Site
        Return rpt
    End Function
