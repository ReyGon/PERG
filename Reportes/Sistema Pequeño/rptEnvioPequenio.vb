...
Public Class rptEnvioPequenio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptEnvioPequenio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEnvioPequenio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEnvioPequenio = New rptEnvioPequenio()
        rpt.Site = Me.Site
        Return rpt
    End Function
