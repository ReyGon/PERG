...
Public Class rptTodosVendidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "laFuente.rptTodosVendidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTodosVendidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTodosVendidos = New rptTodosVendidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
