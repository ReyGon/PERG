...
Public Class frmComprasGuia
    ...
    Private Sub fnLlenarDatos()
        ...
        Dim entrada As tblEntrada = (From x In ctx.tblEntradas.AsEnumerable Where x.idEntrada = Codigo _
                                                  Select x).FirstOrDefault

        'Asignamos los datos
        lblDocumento.Text = entrada.documento
        lblFecha.Text = Format(entrada.fechaRegistro, mdlPublicVars.formatoFecha)
    ...
    Private Sub frm_eliminaRegistro() Handles Me.eliminaRegistro
        ...
        Try
            Dim m As tblEnvio_Entrada = (From e1 In ctx.tblEnvio_Entrada Where e1.envio = Me.txtCodigo.Text Select e1).First()
            ctx.DeleteObject(m)
    ...
    Private Sub btnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        ...
        Try
            ...
            Dim guia_factura As New tblEnvio_Entrada
            guia_factura.envio = m.codigo
            guia_factura.entrada = Codigo

            ctx.AddTotblEnvio_Entrada(guia_factura)
