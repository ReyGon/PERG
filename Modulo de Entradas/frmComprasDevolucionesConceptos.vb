...
Public Class frmComprasDevolucionesConceptos
    ...
    Private Sub frmComprasDevolucionesConceptos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Focus()
    ...
    Private Sub fnLlenar()
        Try
            ...
            lblEntrada.Text = entrada.documento
            ...
            Dim ajustes = (From x In ctx.tblDevolucionProveedorDetalles Where x.tblDevolucionProveedor.entrada = codEntrada _
                           And x.tblDevolucionProveedor.anulado = False And x.tblDevolucionProveedor.tipoMovimiento = mdlPublicVars.Proveedor_DevolucionCodigoMovimiento _
