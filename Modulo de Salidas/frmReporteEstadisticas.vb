...
Public Class frmReporteEstadisticas
    ...
    Private Sub frmReporteEstadisticas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            mdlPublicVars.comboActivarFiltro(Me.cmbTipoRepuesto)
    ...
    Private Sub fnLlenarCombos()
        Try
            ...
            Using conn As EntityConnection = New EntityConnection(mdlPublicVars.entityBuilder.ToString)
                ...
                Dim repuesto = (From x In conexion.tblArticuloRepuestoes Select Codigo = 0, Nombre = "<-Todos->").Union(From x In conexion.tblArticuloRepuestoes Select Codigo = x.codigo, Nombre = x.nombre)

                With cmbTipoRepuesto
                    .DataSource = Nothing
                    .ValueMember = "Codigo"
                    .DisplayMember = "Nombre"
                    .DataSource = repuesto
    ...
    Private Sub fnCargarCombos()
        Try
            If Me.rbtRotaciones.Checked = True Then
                ...
                Me.cmbTipoRepuesto.Enabled = False
            ...
            ElseIf Me.rbtVentasLinea.Checked = True Then
                ...
                Me.cmbCliente.Enabled = False
                Me.cmbTipoVehiculo.Enabled = True
                Me.cmbTipoRepuesto.Enabled = True
                Me.pbInformacion.Enabled = False
                Me.txtTop.Enabled = False
                Me.cmbPais.Enabled = False
                Me.cmbDepartamento.Enabled = False
        ...
        Try
            ...
            Using conn As EntityConnection = New EntityConnection(mdlPublicVars.entityBuilder.ToString)
                ...
                If Me.rbtRotaciones.Checked Then
                    r.tabla = EntitiToDataTable(conexion.sp_ReporteRotacionArticulos(fechainicio, fechafin, CInt(Me.cmbVendedor.SelectedValue), CInt(Me.cmbProducto.SelectedValue), CInt(Me.cmbTipoVehiculo.SelectedValue)))
                    r.reporte = "rptRotacion.rpt"
                ...
                ElseIf Me.rbtVentasLinea.Checked Then
                    r.tabla = EntitiToDataTable(conexion.sp_ReporteVentasVendedorLinea(fechainicio, fechafin, CInt(Me.cmbTipoRepuesto.SelectedValue), CInt(Me.cmbTipoVehiculo.SelectedValue), CInt(Me.cmbVendedor.SelectedValue)))
                ...
                ElseIf Me.rbtVentaLineaPais.Checked Then
                    r.tabla = EntitiToDataTable(conexion.sp_ReporteVentasVendedorLineaMeses(fechainicio, fechafin, CInt(Me.cmbTipoRepuesto.SelectedValue), CInt(cmbTipoVehiculo.SelectedValue), CInt(Me.cmbVendedor.SelectedValue), CInt(Me.cmbPais.SelectedValue)))
